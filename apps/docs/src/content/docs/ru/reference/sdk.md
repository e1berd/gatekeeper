...
доступны на неаутентифицированной странице входа. Нетронутый типизированный контракт остаётся в
`gk.raw` для процедур, которым ещё не дано высокоуровневое имя.
